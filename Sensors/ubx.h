...
//UBX config strings
#define AIR_4G_3D {0xB5,0x62,0x06,0x24,0x24,0x00,0xFF,0xFF,0x08,0x02,0x00,0x00,0x00,0x00,0x10,0x27,0x00,0x00,0x05,0x00\
...
#define USART1_115200_UBX {0xB5,0x62,0x06,0x00,0x14,0x00,0x01,0x00,0x00,0x00,0xD0,0x08,0x00,0x00,0x00,0xC2,0x01,0x00,0x07\
,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0xBE,0x72}
//^this configures the ublox5 usart1 to 115200 baud ubx out, all protocols in
#define HZ5_UPDATE {0xB5,0x62,0x06,0x08,0x06,0x00,0xC8,0x00,0x01,0x00,0x01,0x00,0xDE,0x6A}
//^this sets measurement period to 200ms, and averaging over 1 measurement period giving 5hz. Some forum posts say 10hz poss
#define SBAS_OFF {0xB5,0x62,0x06,0x16,0x08,0x00,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x26,0x97}
//^turns off the correction subsystem, this frees up the ublox rtos and allows faster update rates than datasheet spec
#define LLN_ENABLE {0xB5,0x62,0x06,0x01,0x08,0x00,0x01,0x02,0x00,0x01,0x00,0x00,0x00,0x00,0x13,0xBE,
//^turns on just the lat long alt on
